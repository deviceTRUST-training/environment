...
resource "azurerm_virtual_machine" "vm_byod" {
  ...
  # name                  = "${var.azure-environment.prefix}_vm_byod"
  name                  = "${var.azure-environment.prefix}_${var.azure-environment.instance_count}_vm_byod"
  ...
  storage_os_disk {
    name              = "${var.azure-environment.prefix}_vm_byod_osdisk"
    caching           = "ReadWrite"
